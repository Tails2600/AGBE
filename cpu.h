...
int doOpcode()
{
    switch(opcode)
    {
        ...
        case 0xFE: // Flags Need Fixed
            help0xFE = af[0] - memory[pc + 1];
            Fbitbuffer = af[1];
            if(help0xFE == 0x00)
            {
                Fbitbuffer[7] = 1;
